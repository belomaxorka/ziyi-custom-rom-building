...
* Оперативной памяти МИНИМУМ 32 GB (если у вас мало оперативной памяти, то рекомендуется использовать swap!)
...
> * В случае появления ошибок, не беспокойтесь, по окончанию процесса сделайте синхронизацию ещё раз
