...
* Дистрибутив Ubuntu-24.04 и выше
* Оперативной памяти МИНИМУМ 16 GB (если у вас мало оперативнйо памяти, то рекомендуется использовать swap!)
...
sudo apt install unzip bc bison build-essential ccache curl flex g++-multilib gcc-multilib git git-lfs gnupg gperf imagemagick lib32readline-dev lib32z1-dev libelf-dev liblz4-tool libsdl1.2-dev libssl-dev libxml2 libxml2-utils lzop pngcrush rsync schedtool squashfs-tools xsltproc zip zlib1g-dev
```
...
## Выбираем каталог (да, да, снова, вдруг вы отсюда ушли)
